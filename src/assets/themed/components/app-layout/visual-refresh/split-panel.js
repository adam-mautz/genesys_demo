...
function SplitPanel({ children }) {
    const { handleSplitPanelClick, handleSplitPanelPreferencesChange, handleSplitPanelResize, isMobile, isSplitPanelForcedPosition, isSplitPanelOpen, setSplitPanelReportedSize, setSplitPanelReportedHeaderHeight, splitPanelPosition, splitPanelSize, setSplitPanelToggle, splitPanelRefs, headerHeight, footerHeight, } = useAppLayoutInternals();
    const context = {
        bottomOffset: 0,
        getMaxHeight: () => {
