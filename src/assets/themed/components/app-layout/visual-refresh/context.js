...
export const AppLayoutInternalsProvider = React.forwardRef((_a, forwardRef) => {
    ...
    const handleNavigationClick = useCallback(function handleNavigationChange(isOpen) {
    ...
    const handleSplitPanelResize = useCallback(function handleSplitPanelChange(detail) {
